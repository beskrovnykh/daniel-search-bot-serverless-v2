...
import json
import logging
from typing import TypeVar, TypedDict, Union, Mapping
...
class ContentModerationSchema(OpenAiBase):
    """
    Classify the content of the given text:

    {content}
    """

    category: str = Field(description="Either toxicity, profanity, discrimination, insult, threat, vulgarity, normal.")


class ContentModeration(BaseModel, OpenAiMixin):
    """
    Classify the content of the following: {text}
    """

    words_to_categories: Mapping[str, ContentModerationSchema]
    overall_category: ContentModerationSchema
